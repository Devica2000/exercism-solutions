...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    threshold_90 = 0.9 * threshold
    threshold_plus_10 = threshold + (0.10 * threshold)
    threshold_minus_10 = threshold - (0.1 * threshold)
                        
    if value < threshold_90:
        return 'LOW'
    if value <= threshold_plus_10 and value > threshold_minus_10:
        return 'NORMAL'
    return 'DANGER'
