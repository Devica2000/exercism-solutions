...
def check_drinks(drink_name, drink_ingredients):
    ...
    """
    intersection = set(drink_ingredients).intersection(ALCOHOLS)
    if intersection:
...
def categorize_dish(dish_name, dish_ingredients):
    ...
    # if dish_ingredients.issuperset(VEGETARIAN):
    #     return categorize_dish + ":" + " " + "VEGETARIAN"
...
def compile_ingredients(dishes):
    ...
    final_list = set()
    for dish in dishes:
        final_list = final_list.union(dish)
    return final_list
...
def separate_appetizers(dishes, appetizers):
    ...
    main_dishes = set(dishes).difference(set(appetizers))
